        ...
        <tbody>
            @foreach ($categories as $category)
                <tr>
                    ...
                    <td>{{ $category->name }}</td>
                    <td> 
                        <a class="text-decoration-none text-dark" href="{{ route('edit-category/' . $category->id) }}"><svg
                        ...
                        <a class="text-decoration-none text-danger" href="{{ route('delete-category/' . $category->id) }}" onclick="return confirm('Are you sure?')">
